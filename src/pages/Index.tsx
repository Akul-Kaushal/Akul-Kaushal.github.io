          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              <div className="space-y-4 text-slate">
                <p>
                  I'm a <strong>Frontend Developer</strong> with experience in building responsive 
                  websites and web applications. I specialize in JavaScript and have professional 
                  experience working with React and TypeScript.
                </p>
                <p>
                  I love learning new technologies and am constantly exploring the latest tools 
                  in the web development ecosystem. I have a knack for solving complex problems 
                  and enjoy optimizing applications for better performance.
                </p>
                <p>
                  In addition to my technical skills, I bring strong communication abilities and 
                  enjoy collaborating with teams to deliver exceptional digital solutions.
                </p>
              </div>
            ...
            <div className="space-y-6">
              ...
              <SkillCard 
                title="Tools & Others"
                skills={['Git', 'Webpack', 'Figma', 'Responsive Design', 'SEO', 'Testing']}
              />
            </div>
          </div>
        </div>
